...
const translations = {
  fr: {
    ...
    checkIn: {
      ...
      activeNow: 'Actuellement présent',
      allCaregivers: 'Tous les autres aides-soignants',
      addYourName: 'Ajouter mon nom à la liste',
      arrived: 'Arrivée',
      typeYourName: 'Tapez votre nom complet',
      saveMyName: 'Enregistrer mon nom',
  ...
  en: {
    ...
    checkIn: {
      ...
      activeNow: 'Currently Present',
      allCaregivers: 'All Other Caregivers',
      addYourName: 'Add my name to the list',
      arrived: 'Arrived',
      typeYourName: 'Type your full name',
      saveMyName: 'Save my name',
